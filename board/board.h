...
#define GPIOA_ARD_A2                2U
#define GPIOA_ARD_A3                3U
#define GPIOA_ARD_A4                4U
#define GPIOA_ARD_A5                5U
#define GPIOA_ARD_A6                6U
#define GPIOA_ARD_A7                7U
...
#define LINE_ARD_A2                 PAL_LINE(GPIOA, 2U)
#define LINE_ARD_A3                 PAL_LINE(GPIOA, 3U)
#define LINE_ARD_A4                 PAL_LINE(GPIOA, 4U)
#define LINE_ARD_A5                 PAL_LINE(GPIOA, 5U)
#define LINE_ARD_A6                 PAL_LINE(GPIOA, 6U)
#define LINE_ARD_A7                 PAL_LINE(GPIOA, 7U)
...
#define LINE_SERIAL_TX              PAL_LINE(GPIOB, 6U)

#define LINE_POWER_SWITCH           PAL_LINE(GPIOA, 7U)
#define LINE_REAR_LIGHTS            PAL_LINE(GPIOA, 8U)
 ...
 * PA2  - ARD_A2                    (alternate 1).
 * PA3  - ARD_A3                    (input pullup).
 * PA4  - ARD_A4                    (input pullup).
 * PA5  - ARD_A5                    (input pullup).
 * PA6  - ARD_A6                    (input pullup).
 * PA7  - ARD_A7                    (output pushpull).
 * PA8  - ARD_D9                    (input pullup).
 * PA9  - ARD_D1                    (alternate 1).
 * PA10 - ARD_D0                    (alternate 1).
 * PA11 - ARD_D10                   (alternate 4 - CAN RX).
 * PA12 - ARD_D2                    (alternate 4 - CAN TX).
...
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(0U) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_ARD_A7) |         \
                                     PIN_MODE_OUTPUT(GPIOA_ARD_D9) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_ARD_A0) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_ARD_A7) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_ARD_A0) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOA_ARD_A6) |           \
                                     PIN_ODR_LOW(GPIOA_ARD_D9) |           \
...
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_ARD_D3) |         \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_SERIAL_TX) |         \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_ARD_D3) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_SERIAL_TX) |       \
